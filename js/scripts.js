$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Winona and Matt's Wedding",

            // Event start date
            start: new Date('May 4, 2024 16:30'),
            ...
            end: new Date('May 4, 2024 21:30'),

            // Event Address
            address: '414 N Fillmore St, Arlington, VA 22201',

            // Event Description
            description: "Winona and Matt's Wedding! For any queries or issues, please contact us at thedrsnice@gmail.com ."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post("https://script.google.com/macros/s/AKfycbxPuFirp0CXemXJDtKUBtDWWrxRbFvXw03LzIB860wfvPwSnNekF5qrfblUSemtN0Km/exec", data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 36.5932759, lng: 82.27027720000001};
...
function initBBSRMap() {
    var la_fiesta = {lat: 36.305826, lng: 82.85480189999998};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
